                        ...
                        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
                            ...
                            <div className="flex items-center gap-3 text-xs">
                                ...
                                <Show when="signed-out">
                                    <SignInButton>
                                        <button className="rounded-full border border-amber-400/70 bg-amber-400/10 px-4 py-1.5 text-xs font-semibold text-amber-200 transition-colors hover:bg-amber-400/20">
                                            Sign in
                                        </button>
                                    </SignInButton>
                                </Show>
